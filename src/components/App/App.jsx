// object destructuring with importing just props useEffect and State from react
...
function App() {
  ...
  // this submit event was provided via the form element (HTML)
  // because the form element is now in the form component, we don't need the "event" anymore
  ...
  return (
    <div className="App">
      {/* consume (use) CreatureList component*/}
